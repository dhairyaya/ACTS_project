...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-acts-default-secret-key-change-in-prod')
...
YOLO_MODEL_PATH = BASE_DIR / os.getenv('YOLO_MODEL_PATH', 'complaints/weights/yolo_civic_defect.pt')
